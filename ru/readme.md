...
- title: Легко в использовании
  details: Просто перетащи файлы модулей в папку mods и наслаждайся игрой.
...
- title: Независимость от клиента
  details: Все модули не зависят от их наличия на клиенте и не требуют их наличия на клиенте. И у вас не будет проблем с локализацией.
- title: Действительно основы
  details: Проект состоит из множества модулей из них, 8 модулей + 1 core модуль + 2 future модуля + 1 модуль на рассмотрении.
